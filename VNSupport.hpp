        ...
        class aircraft
        {
                ...
                class support
                {
                        ...
                        class ac119_bomb
                        {
                                ...
                                displayname = $STR_VNX_ARTILLERY_AIRCRAFT_SUPPORT_AC119_BOMB_NAME;
                                icon = "vn\ui_f_vietnam\data\decals\vn_callsign_src_29tas_ca.paa";
                                //description = $STR_VN_ARTILLERY_AIRCRAFT_SUPPORT_AC119_BOMB_DESCRIPTION;
                                description = $STR_VNX_ARTILLERY_AIRCRAFT_SUPPORT_AC119_BOMB_DESCRIPTION;
        ...
        class transport
        {
                ...
                class thirty_seats
                {
                        ...
                        class aircow_1
                        {
                                displayname = "Buffalo";
                                //icon = "vn\ui_f_vietnam\data\decals\";
                                description = "A CH-57A Chinook, available for transport. Can carry up to thirty passengers, comes armed with two M60 door gunners.";
                ...
                class medevac_1
                {
                        ...
                        class dustoff_1
                        {
                                displayname = "Dustoff 1";
                                //icon = "vn\ui_f_vietnam\data\decals\";
                                description = "A UH-1D Dustoff, available for Medevac. Can carry up to seven wounded and two medics.";
                                vehicleclass = "vn_b_air_ch47_02_02";
                                hook = 1;
                                cooldown = (5);
                                cost = 0;
                        };
                        class dustoff_2
                        {
                                displayname = "Dustoff 2";
                                //icon = "vn\ui_f_vietnam\data\decals\";
                                description = "A CH-57A Chinook, available for Medevac. Can carry up to eighteen wounded and two medics.";
                                vehicleclass = "vn_b_air_ch47_02_02";
                                hook = 1;
                                cooldown = (5);
                                cost = 0;
